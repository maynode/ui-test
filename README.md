...
**Windows CMD:**
```batch
set ENV=qa && pnpm run test
```

**Windows PowerShell:**
```powershell
$env:ENV="qa"; pnpm run test
```

**Mac/Linux/WSL:**
```bash
ENV=qa pnpm run test
```
...
**Windows CMD:**
```batch
set ENV=qa && pnpm run test:single
```

**Windows PowerShell:**
```powershell
$env:ENV="qa"; pnpm run test:single
```

**Mac/Linux/WSL:**
```bash
ENV=qa pnpm run test:single
```
...
**Windows CMD:**
```batch
set ENV=qa && pnpm run test:parallel
```

**Windows PowerShell:**
```powershell
$env:ENV="qa"; pnpm run test:parallel
```

**Mac/Linux/WSL:**
```bash
ENV=qa pnpm run test:parallel
```
...
**Windows CMD:**
```batch
set ENV=qa && pnpm run test:serial
```

**Windows PowerShell:**
```powershell
$env:ENV="qa"; pnpm run test:serial
```

**Mac/Linux/WSL:**
```bash
ENV=qa pnpm run test:serial
```
...
**Windows CMD:**
```batch
set "ENV=qaApi" && set "REQRES_API_KEY=your_reqres_key" && pnpm run test:api
```

**Windows PowerShell:**
```powershell
$env:ENV="qaApi"; $env:REQRES_API_KEY="your_reqres_key"; pnpm run test:api
```

**Mac/Linux/WSL:**
```bash
ENV=qaApi REQRES_API_KEY=your_reqres_key pnpm run test:api
```
...
**Windows CMD:**
```batch
set ENV=qa && pnpm run test:visual
```

**Windows PowerShell:**
```powershell
$env:ENV="qa"; pnpm run test:visual
```

**Mac/Linux/WSL:**
```bash
ENV=qa pnpm run test:visual
```
...
**Windows CMD:**
```batch
set ENV=qa && pnpm run test:device
```

**Windows PowerShell:**
```powershell
$env:ENV="qa"; pnpm run test:device
```

**Mac/Linux/WSL:**
```bash
ENV=qa pnpm run test:device
```

10. For Allure Report generation execute :

```JS
pnpm run allureReport
```
...
12. For debugging test cases add debug points, the press CNTRL+SHIFT+P and type "debug:debug pnpm script", on the edit box select desired script.
...
**Windows CMD:**
```batch
set ENV=qa && pnpm run test:ui
```

**Windows PowerShell:**
```powershell
$env:ENV="qa"; pnpm run test:ui
```

**Mac/Linux/WSL:**
```bash
ENV=qa pnpm run test:ui
```
...
**Windows CMD:**
```batch
set ENV=qa && pnpm run test:accessibility
```

**Windows PowerShell:**
```powershell
$env:ENV="qa"; pnpm run test:accessibility
```

**Mac/Linux/WSL:**
```bash
ENV=qa pnpm run test:accessibility
```
...
```JS
docker run -e ENV=qa --name playContainer playtest
```
